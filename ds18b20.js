...
function checkTemp() {
    ...
    fetch('https://servicoldingenieria.com/checkTemp.php',  {cache: 'no-cache' })
...
function sendEmailAlert() {
    ...
    fetch('https://servicoldingenieria.com/back-end/emailDS.php')
    .then(response => response.json())
    .then(data => {
        if (data.length > 0) {
...
function getThreshold() {
    ...
    return fetch('https://servicoldingenieria.com/umbralDS.php', { cache: 'no-cache' })
        .then(response => response.json())
        .then(data => {
